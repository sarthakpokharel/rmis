   ...
   function showCal(scwEle,scwSourceEvent) {scwShow(scwEle,scwSourceEvent);};
                 ...
                 if (scwExpValYear.exec(scwArrSeed[0])  == null ||
                    ...
                    {if (scwShowInvalidDateMsg)
                     ...
                     scwArrSeed[2] = 1;                              // Day
                        ...
                        // Day     in scwArrSeed[2]----> comment by me
    ...
    document.write(
     ...
     "</iframe>" +
     "<table id='scw' class='scw' style='background-image:url(images/bg_g.gif)' cellspacing=0 cellpading=0>" +
       "<tr class='scw'>" +
         "<td class='scw'>" +
           "<table class='scwHead' id='scwHead' width='100%' " +
            ...
            "<tr id='scwDrag' style='display:none;'>" +
                ...
                "</td>" +
            "</tr>" +
            "<tr class='scwHead' style='background-image:url(images/boxbuttom.gif)'>" +
                 "<td class='scwHead'>" +
                    "<input id='uxp_hdr_webSearchButton' type='button' value='<' " +
