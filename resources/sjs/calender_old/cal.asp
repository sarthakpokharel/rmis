...
<tr >
	<td colspan=3><select id='year' name='year' style="width:100%; border:0px;background-color:#D5EDB3; font-size:17px;" onchange="getmonthdata(this.value + '/' + document.getElementById('month').value + '/1');">
	<script language="javascript">
	var yearloop
