...
document.write('.btn     { width: 22px; height: 20px; border: 0px solid silver; margin: 0; padding: 0; background-image: url(images/footer.gif);}\n');
document.write('.btnOver { width: 22px; height: 20px; border: 1px outset; background-image: silver; background-image: url(../images/background_btn_hover.gif);}\n');
document.write('.btnDown { width: 22px; height: 20px; border: 1px inset; background-color: FFCC99; background-image: url(../images/background_btn_down.gif); }\n');
document.write('.btnNA   { width: 22px; height: 20px; border: 1px solid silver; filter: alpha(opacity=25); }\n');
document.write('.cMenu     { background-color: threedface; color: menutext; cursor: Default; font-family: MS Sans Serif; font-size: 8pt; padding: 2 12 2 16;background-image:url(images/bg_s.gif) }');
...
this.imgURL = 'editor_includes/editor_images/';
this.debug  = 0;
...
function editor_generate(objname,userConfig) {
  ...
  var tblOpen  = '<table border=0 cellspacing=0 cellpadding=0 style="float: left; background-image:url(images/footer.gif); height=23px;"  unselectable="on"><tr><td style="border: none; padding: 1 0 0 0"><nobr>';
  ...
  var editor = '<span id="_editor_toolbar" style="background-image:url(images/footer.gif)"><table border=0 cellspacing=0 cellpadding=0 bgcolor="silver" style="padding: 1 0 0 2" width=' + config.width + ' unselectable="on" style="background-image:url(images/footer.gif)"><tr><th>\n'
  + toolbar
  + '</th></tr></table>\n'
  + '</th></tr></table></span>\n'
